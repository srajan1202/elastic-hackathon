...
//        sqsMessage.setBody("""
//                 Tesla announces that it will install solar panels on all its new factory rooftops to reduce carbon emissions and promote renewable energy usage.
//                Source: Tesla Press Release
//                """);
//        event.setRecords(List.of(sqsMessage));
//        new AgentMain().handleRequest(event, new Context() {
//            @Override
